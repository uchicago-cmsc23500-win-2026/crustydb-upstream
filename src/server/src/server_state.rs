...
pub struct ServerState {
    ...
    // global managers for different db tasks
    pub managers: &'static Managers,
    // worker threads to handle async/offshoot jobs for parent handler threads
    pub workers: Mutex<Vec<worker::Worker>>,
